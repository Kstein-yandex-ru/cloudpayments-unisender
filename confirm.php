...
if ($_SERVER['REQUEST_METHOD'] == 'POST' and isset($_POST['Email']) and $_POST['Status'] == 'Authorized') {
   ...
   if ($dataDecoded->cloudPayments->recurrent !== null) {

      $template_id = FIRST_RECURRENT_TEMPLATE;
   } else {

      $template_id = PAYED_TEMPLATE;
   }
